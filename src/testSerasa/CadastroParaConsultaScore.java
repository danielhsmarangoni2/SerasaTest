...
public class CadastroParaConsultaScore {
	...
	public void Score () {
		...
		driver.findElement(By.xpath("//div[2]/a[4]")).click(); // Seleciona o Consulta Score
		driver.findElement(By.linkText("Consulte agora")).click(); // Clicando no bot�o Consulte Agora
		...
		// Obs n�o cliquei no bot�o de cadastro devido a n�o ser um CPF valido.
